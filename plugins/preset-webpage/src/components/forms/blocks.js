  ...
  addBlock(typeForm, {
    ...
    content: {
      ...
      components: [
        {
          components: [
            { type: typeLabel, components: editor.I18n.t('name') },
            { type: typeInput },
          ]
        }, {
          components: [
            { type: typeLabel, components: editor.I18n.t('email') },
            { type: typeInput, attributes: { type: 'email' } },
          ]
        }, {
          components: [
            { type: typeLabel, components: editor.I18n.t('gender') },
          ...
          components: [
            { type: typeLabel, components: editor.I18n.t('message') },
            { type: typeTextarea },
          ]
        }, {
    ...
    attributes: { class: 'gjs-form-component' },
  });
